(function(f,n,g){var h;a:{var l=/audio(.min)?.js.*/,m=document.getElementsByTagName("script");h=0;for(var k=m.length;h<k;h++){var p=m[h].getAttribute("src");if(l.test(p)){h=p.replace(l,"");break a}}h=void 0}l='      <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -1px;">         <param name="movie" value="$2?playerInstance='+f+'.instances[\'$1\']&datetime=$3">         <param name="allowscriptaccess" value="always">         <embed name="$1" src="$2?playerInstance='+
f+'.instances[\'$1\']&datetime=$3" width="1" height="1" allowscriptaccess="always">       </object>';m=h+"player-graphics.gif";h+="audiojs.swf";k=document.createElement("audio");k=!(k.canPlayType&&k.canPlayType("audio/mpeg;").replace(/no/,""));g[f]={instanceCount:0,instances:{},flashSource:l,settings:{autoplay:!1,loop:!1,preload:!0,imageLocation:m,swfLocation:h,useFlash:k,hasFlash:function(){if(navigator.plugins&&navigator.plugins.length&&navigator.plugins["Shockwave Flash"])return!0;if(navigator.mimeTypes&&
...
trackEnded:function(){},flashError:function(){var a=this.settings.createPlayer,b=j(a.errorMessageClass,this.wrapper),c='Missing <a href="http://get.adobe.com/flashplayer/">flash player</a> plugin.';this.mp3&&(c+=' <a href="'+this.mp3+'">Download audio file</a>.');g[f].helpers.removeClass(this.wrapper,a.loadingClass);g[f].helpers.addClass(this.wrapper,a.errorClass);b.innerHTML=c},loadError:function(){var a=this.settings.createPlayer,b=j(a.errorMessageClass,this.wrapper);g[f].helpers.removeClass(this.wrapper,
a.loadingClass);g[f].helpers.addClass(this.wrapper,a.errorClass);b.innerHTML='Error loading: "'+this.mp3+'"'},init:function(){g[f].helpers.addClass(this.wrapper,this.settings.createPlayer.loadingClass)},loadStarted:function(){var a=this.settings.createPlayer,b=j(a.durationClass,this.wrapper),c=Math.floor(this.duration/60),d=Math.floor(this.duration%60);g[f].helpers.removeClass(this.wrapper,a.loadingClass);b.innerHTML=(10>c?"0":"")+c+":"+(10>d?"0":"")+d},loadProgress:function(a){var b=this.settings.createPlayer,
c=j(b.scrubberClass,this.wrapper);j(b.loaderClass,this.wrapper).style.width=c.offsetWidth*a+"px"},playPause:function(){this.playing?this.settings.play():this.settings.pause()},play:function(){g[f].helpers.addClass(this.wrapper,this.settings.createPlayer.playingClass)},pause:function(){g[f].helpers.removeClass(this.wrapper,this.settings.createPlayer.playingClass)},updatePlayhead:function(a){var b=this.settings.createPlayer,c=j(b.scrubberClass,this.wrapper);j(b.progressClass,this.wrapper).style.width=
c.offsetWidth*a+"px";b=j(b.playedClass,this.wrapper);c=this.duration*a;a=Math.floor(c/60);c=Math.floor(c%60);b.innerHTML=(10>a?"0":"")+a+":"+(10>c?"0":"")+c}},create:function(a,b){b=b||{};return a.length?this.createAll(b,a):this.newInstance(a,b)},createAll:function(a,b){var c=b||document.getElementsByTagName("audio"),d=[];a=a||{};for(var e=0,g=c.length;e<g;e++)d.push(this.newInstance(c[e],a));return d},newInstance:function(a,b){var c=this.helpers.clone(this.settings),d="audiojs"+this.instanceCount,
...
a));return d.getElementsByTagName("audio")[0]},attachEvents:function(a,b){if(b.settings.createPlayer){var c=b.settings.createPlayer,d=j(c.playPauseClass,a),e=j(c.scrubberClass,a);g[f].events.addListener(d,"click",function(){b.playPause.apply(b)});g[f].events.addListener(e,"click",function(a){a=a.clientX;var c=this,d=0;if(c.offsetParent){do d+=c.offsetLeft;while(c=c.offsetParent)}b.skipTo((a-d)/e.offsetWidth)});b.settings.useFlash||(g[f].events.trackLoadProgress(b),g[f].events.addListener(b.element,
...
return c.firstChild},getSwf:function(a){a=document[a]||window[a];return 1<a.length?a[a.length-1]:a}},events:{memoryLeaking:!1,listeners:[],addListener:function(a,b,c){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(this.listeners.push(a),this.memoryLeaking||(window.attachEvent("onunload",function(){if(this.listeners)for(var a=0,b=this.listeners.length;a<b;a++)g[f].events.purge(this.listeners[a])}),this.memoryLeaking=!0),a.attachEvent("on"+b,function(){c.call(a,window.event)}))},trackLoadProgress:function(a){if(a.settings.preload){var b,
...
ready:function(a){var b=window,c=!1,d=!0,e=b.document,f=e.documentElement,g=e.addEventListener?"addEventListener":"attachEvent",h=e.addEventListener?"removeEventListener":"detachEvent",j=e.addEventListener?"":"on",k=function(d){if(!("readystatechange"==d.type&&"complete"!=e.readyState)&&(("load"==d.type?b:e)[h](j+d.type,k,!1),!c&&(c=!0)))a.call(b,d.type||d)},l=function(){try{f.doScroll("left")}catch(a){setTimeout(l,50);return}k("poll")};if("complete"==e.readyState)a.call(b,"lazy");else{if(e.createEventObject&&
f.doScroll){try{d=!b.frameElement}catch(m){}d&&l()}e[g](j+"DOMContentLoaded",k,!1);e[g](j+"readystatechange",k,!1);b[g](j+"load",k,!1)}}}};g[n]=function(a,b){this.element=a;this.wrapper=a.parentNode;this.source=a.getElementsByTagName("source")[0]||a;var c=a.getElementsByTagName("source")[0];this.mp3=a.getAttribute("src")||(c?c.getAttribute("src"):null);this.settings=b;this.loadStartedCalled=!1;this.loadedPercent=0;this.duration=1;this.playing=!1};g[n].prototype={updatePlayhead:function(){this.settings.updatePlayhead.apply(this,
[this.element.currentTime/this.duration])},skipTo:function(a){a>this.loadedPercent||(this.element.currentTime=this.duration*a,this.updatePlayhead())},load:function(a){this.loadStartedCalled=!1;this.source.setAttribute("src",a);this.element.load();this.mp3=a;g[f].events.trackLoadProgress(this)},loadError:function(){this.settings.loadError.apply(this)},init:function(){this.settings.init.apply(this)},loadStarted:function(){if(!this.element.duration)return!1;this.duration=this.element.duration;this.updatePlayhead();
...
this.settings.preload||(this.settings.preload=!0,this.element.setAttribute("preload","auto"),g[f].events.trackLoadProgress(this));this.playing=!0;this.element.play();this.settings.play.apply(this)},pause:function(){this.playing=!1;this.element.pause();this.settings.pause.apply(this)},setVolume:function(a){this.element.volume=a},trackEnded:function(){this.skipTo.apply(this,[0]);this.settings.loop||this.pause.apply(this);this.settings.trackEnded.apply(this)}};var j=function(a,b){var c=[];b=b||document;
if(b.getElementsByClassName)c=b.getElementsByClassName(a);else{var d,e,f=b.getElementsByTagName("*"),g=RegExp("(^|\\s)"+a+"(\\s|$)");d=0;for(e=f.length;d<e;d++)g.test(f[d].className)&&c.push(f[d])}return 1<c.length?c:c[0]}})("audiojs","audiojsInstance",this);
